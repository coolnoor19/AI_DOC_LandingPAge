...
export interface DotGridProps {
  ...
  baseColor?: string;        // hex color close to mouse
  activeColor?: string;      // hex color under the pointer
  proximity?: number;        // color interpolation radius
  speedTrigger?: number;     // min pointer speed (px/s) to trigger inertia
  shockRadius?: number;      // click shock-wave radius
  shockStrength?: number;    // click push intensity
  maxSpeed?: number;         // cap pointer speed
  resistance?: number;       // InertiaPlugin resistance
  returnDuration?: number;   // time to return to rest
  className?: string;
  style?: React.CSSProperties;
}
