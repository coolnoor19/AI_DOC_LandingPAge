        ...
        <header className="mx-auto mt-8 max-w-6xl px-4">
            <div className="flex items-center justify-between rounded-full bg-white/5 px-6 py-3 backdrop-blur ring-1 ring-white/10">
                ...
                <Link to="/" className="flex items-center gap-3">
                    ...
                    <span className="font-semibold tracking-wide">AIDoc Nest</span>
                </Link>
                ...
                <nav className="text-sm">
                    <ul className="flex items-center gap-2">
                        ...
                        <li className="relative group">
                            {/* the trigger uses 'active' look when any /resources/* route is active */}
                            <button
                                className={`${navItem} ${isResources ? active : ""}`}
                                aria-haspopup="menu"
                                aria-expanded={isResources}
                            >
                                Resources ▾
                            </button>

                            {/* menu — appears on hover/focus */}
                            <div
                                className="invisible absolute left-1/2 top-9 z-50 w-72 -translate-x-1/2
                           ...
                           focus-within:visible focus-within:opacity-100"
                            ...
                            >
                                {/* subtle glow */}
                                <div className="pointer-events-none absolute -inset-[1px] rounded-2xl bg-gradient-to-r from-fuchsia-500/20 via-purple-400/20 to-emerald-400/20 blur-xl" />
                                <ul className="relative space-y-1">
                                    <li>
                                        <NavLink
                                            to="/resources/faq"
                                            className={({ isActive }) =>
                                                `block rounded-xl px-3 py-2.5 hover:bg-white/10 transition ${isActive ? "bg-white/10 ring-1 ring-white/15" : ""}`
                                            }
                                            role="menuitem"
                                        >
                                            <div className="text-sm font-medium">FAQ</div>
                                            <div className="text-[12px] text-white/70">Answers to common questions</div>
                                        </NavLink>
                                    </li>
                                    <li>
                                        <NavLink
                                            to="/resources/why-ai-doc-nest"
                                            className={({ isActive }) =>
                                                `block rounded-xl px-3 py-2.5 hover:bg-white/10 transition ${isActive ? "bg-white/10 ring-1 ring-white/15" : ""}`
                                            }
                                            role="menuitem"
                                        >
                                            <div className="text-sm font-medium">Why AIDoc Nest</div>
                                            <div className="text-[12px] text-white/70">What makes us different</div>
                                        </NavLink>
                                    </li>
                                    <li>
                                        <NavLink
                                        ...
                                        >
                                            ...
                                            <div className="text-[12px] text-white/70">Quick start & best practices</div>
                                        </NavLink>
                                    </li>
                                </ul>
                            </div>
