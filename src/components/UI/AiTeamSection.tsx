...
export default function AiTeamSection() {
    return (
        <>
            {/* NEW: Headline + subheadline (above the component) */}
            <section className="relative isolate overflow-hidden  px-6 md:px-10 lg:px-16 py-16 md:py-24">
                {/* soft glow under the text */}
                <div className="pointer-events-none absolute inset-0 -z-10">
                    <div className="absolute inset-x-0 bottom-0 h-96 bg-[radial-gradient(60%_60%_at_50%_100%,rgba(20,184,166,0.25),transparent_70%)]" />
                </div>
                ...
                <div className="mx-auto max-w-6xl text-left">
                    ...
                    {/* <p className="mt-6 max-w-4xl text-center text-lg md:text-xl text-white/80">
                        Supercharge your productivity with a dedicated team of AI agents.
                        Automate tasks, research, and collaborate in one unified workspace.
                    </p> */}
                </div>
            </section>

            {/* EXISTING SECTION (kept as-is) */}
            <section
                className="
        ...
        "
            >
                ...
                <div className="mx-auto grid max-w-6xl items-center gap-10 md:grid-cols-2 lg:gap-14">
                    ...
                    {/* RIGHT: App mock */}
                    <div className="order-1 md:order-2 relative mx-auto w-full max-w-2xl">
                        {/* outer glow */}
