...
function CapturedPanel({
  className,
  children,
  topOffsetRem = 8, // match your sticky offset (top-24 => 6rem; you used 8rem space for max height)
}: {
  className?: string;
...
export default function WhyAIDocNest() {
  ...
  return (
    <section className="px-6">
      ...
      {/* Why Doculance-style block with sticky reading panel + scroll capture */}
      <div className="mx-auto mt-14 max-w-6xl grid gap-8 md:grid-cols-12">
        {/* LEFT: stacked images */}
        <div className="md:col-span-5 space-y-4 order-2 md:order-1">
          <img
        ...
        {/* RIGHT: sticky article with internal scroll capture */}
        <article className="md:col-span-7 order-1 md:order-2 relative">
          <div className="sticky top-24">
            <CapturedPanel className="relative rounded-3xl bg-white/5 ring-1 ring-white/10 p-6 md:p-7">
